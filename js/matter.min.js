...
function(e) {
    ...
    return function e(t, n, o) {
            ...
            function() {
                ...
                o.scale = function(e, n, r, s) {
                    for (var a = 0; a < e.parts.length; a++) {
                        ...
                        e.isStatic || (u.area = i.area(u.vertices), o.setMass(u, e.density * u.area), i.translate(u.vertices, {
                            x: -u.position.x,
                            y: -u.position.y
                ...
                o.update = function(e, t, n, o) {
                    ...
                    for (var p = 0; p < e.parts.length; p++) {
                        ...
                        0 !== e.angularVelocity && (i.rotate(f.vertices, e.angularVelocity, e.position), c.rotate(f.axes, e.angularVelocity), p > 0 && r.rotateAbout(f.position, e.angularVelocity, e.position, f.position)),
        ...
        2 : [function(e, t, n) {
            ...
            function() {
                ...
                o.removeComposite = function(e, t, n) {
                    ...
                    if (i !== -1 && (o.removeCompositeAt(e, i), o.setModified(e, !0, !0, !1)), n) for (var s = 0; s < e.composites.length; s++) o.removeComposite(e.composites[s], t, !0);
                    return e
                },
                ...
                o.removeBody = function(e, t, n) {
                    ...
                    if (i !== -1 && (o.removeBodyAt(e, i), o.setModified(e, !0, !0, !1)), n) for (var s = 0; s < e.composites.length; s++) o.removeBody(e.composites[s], t, !0);
                    return e
                },
                ...
                o.removeConstraint = function(e, t, n) {
                    ...
                    if (i !== -1 && o.removeConstraintAt(e, i), n) for (var s = 0; s < e.composites.length; s++) o.removeConstraint(e.composites[s], t, !0);
                    return e
                },
            ...
            function() {
                o.collisions = function(e, t) {
                    for (var n = [], a = t.pairs.table, l = 0; l < e.length; l++) {
                        var c = e[l][0],
                        u = e[l][1];
                        if ((!c.isStatic && !c.isSleeping || !u.isStatic && !u.isSleeping) && o.canCollide(c.collisionFilter, u.collisionFilter) && s.overlaps(c.bounds, u.bounds)) for (var d = c.parts.length > 1 ? 1 : 0; d < c.parts.length; d++) for (var p = c.parts[d], f = u.parts.length > 1 ? 1 : 0; f < u.parts.length; f++) {
                            var m = u.parts[f];
        ...
        6 : [function(e, t, n) {
            ...
            function() {
                    ...
                    for (s = 0; s < o.length; s++) {
                        ...
                        if ((!h.isSleeping || r) && !(h.bounds.max.x < y.bounds.min.x || h.bounds.min.x > y.bounds.max.x || h.bounds.max.y < y.bounds.min.y || h.bounds.min.y > y.bounds.max.y)) {
                            ...
                            if (!h.region || b.id !== h.region.id || r) {
                                ...
                                var w = e(b, h.region);
                                for (p = w.startCol; p <= w.endCol; p++) for (f = w.startRow; f <= w.endRow; f++) {
                                    v = a(p, f),
                                    m = g[v];
                                    var S = p >= b.startCol && p <= b.endCol && f >= b.startRow && f <= b.endRow,
                                    C = p >= h.region.startCol && p <= h.region.endCol && f >= h.region.startRow && f <= h.region.endRow; ! S && C && C && m && u(n, m, h),
                                    (h.region === b || S && !C || r) && (m || (m = l(g, v)), c(n, m, h))
                                }
                                h.region = b,
                                x = !0
                            }
                ...
                d = function(e) {
                    var t, n, o = [];
                    t = s.keys(e.pairs);
                    for (var i = 0; i < t.length; i++) n = e.pairs[t[i]],
        ...
        8 : [function(e, t, n) {
            ...
            function() {
                ...
                o.update = function(e, t, n) {
                    ...
                    f = e.collisionActive,
                    m = [];
                    for (d.length = 0, p.length = 0, f.length = 0, l = 0; l < t.length; l++) o = t[l],
                    o.collided && (s = i.id(o.bodyA, o.bodyB), m.push(s), a = u[s], a ? (a.isActive ? f.push(a) : d.push(a), i.update(a, o, n)) : (a = i.create(o, n), u[s] = a, d.push(a), c.push(a)));
                    for (l = 0; l < c.length; l++) a = c[l],
                    a.isActive && r.indexOf(m, a.id) === -1 && (i.setActive(a, !1, n), p.push(a))
                },
                o.removeOld = function(t, n) {
                    var o, i, r, s, a = t.list,
                    l = t.table,
                    c = [];
                    for (s = 0; s < a.length; s++) o = a[s],
                    i = o.collision,
                    i.bodyA.isSleeping || i.bodyB.isSleeping ? o.timeUpdated = n: n - o.timeUpdated > e && c.push(s);
                    for (s = 0; s < c.length; s++) r = c[s] - s,
                    o = a[r],
                    delete l[o.id],
                    a.splice(r, 1)
                },
            ...
            function() {
                o.ray = function(e, t, n, o) {
                    ...
                    for (var l = i.angle(t, n), c = i.magnitude(i.sub(t, n)), u = .5 * (n.x + t.x), d = .5 * (n.y + t.y), p = a.rectangle(u, d, c, o, {
                        ...
                        var v = e[m];
                        if (s.overlaps(v.bounds, p.bounds)) for (var y = 1 === v.parts.length ? 0 : 1; y < v.parts.length; y++) {
                            var g = v.parts[y];
        ...
        10 : [function(e, t, n) {
            ...
            function() {
                ...
                o.preSolvePosition = function(e) {
                    ...
                    n.isActive && (o = n.activeContacts.length, n.collision.parentA.totalContacts += o, n.collision.parentB.totalContacts += o)
                },
                o.solvePosition = function(e, t) {
                    ...
                    i.isActive && !i.isSensor && (s = i.collision, a = s.parentA, l = s.parentB, c = s.normal, u = r.sub(r.add(l.positionImpulse, l.position, f), r.add(a.positionImpulse, r.sub(l.position, s.penetration, m), v), y), i.separation = r.dot(c, u));
                    for (n = 0; n < e.length; n++) i = e[n],
                    !i.isActive || i.isSensor || i.separation < 0 || (s = i.collision, a = s.parentA, l = s.parentB, c = s.normal, p = (i.separation - i.slop) * t, (a.isStatic || l.isStatic) && (p *= 2), a.isStatic || a.isSleeping || (d = o._positionDampen / a.totalContacts, a.positionImpulse.x += c.x * p * d, a.positionImpulse.y += c.y * p * d), l.isStatic || l.isSleeping || (d = o._positionDampen / l.totalContacts, l.positionImpulse.x -= c.x * p * d, l.positionImpulse.y -= c.y * p * d))
                },
                o.postSolvePosition = function(e) {
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (n.totalContacts = 0, 0 !== n.positionImpulse.x || 0 !== n.positionImpulse.y) {
                            ...
                            r.dot(n.positionImpulse, n.velocity) < 0 ? (n.positionImpulse.x = 0, n.positionImpulse.y = 0) : (n.positionImpulse.x *= o._positionWarming, n.positionImpulse.y *= o._positionWarming)
                        }
                    }
                },
                o.preSolveVelocity = function(e) {
                    ...
                    g = r._temp[1];
                    for (t = 0; t < e.length; t++) if (o = e[t], o.isActive && !o.isSensor) for (i = o.activeContacts, s = o.collision, a = s.parentA, l = s.parentB, c = s.normal, u = s.tangent, n = 0; n < i.length; n++) d = i[n],
                    p = d.vertex,
                    f = d.normalImpulse,
                    m = d.tangentImpulse,
                    0 === f && 0 === m || (y.x = c.x * f + u.x * m, y.y = c.y * f + u.y * m, a.isStatic || a.isSleeping || (v = r.sub(p, a.position, g), a.positionPrev.x += y.x * a.inverseMass, a.positionPrev.y += y.y * a.inverseMass, a.anglePrev += r.cross(v, y) * a.inverseInertia), l.isStatic || l.isSleeping || (v = r.sub(p, l.position, g), l.positionPrev.x -= y.x * l.inverseMass, l.positionPrev.y -= y.y * l.inverseMass, l.anglePrev -= r.cross(v, y) * l.inverseInertia))
                },
                o.solveVelocity = function(e, t) {
                    for (var n = t * t,
                    i = r._temp[0], a = r._temp[1], l = r._temp[2], c = r._temp[3], u = r._temp[4], d = r._temp[5], p = 0; p < e.length; p++) {
                        var f = e[p];
                        if (f.isActive && !f.isSensor) {
                            ...
                            for (var w = 0; w < h.length; w++) {
                                ...
                                i.x = g.x * _ + x.x * F,
                                i.y = g.y * _ + x.y * F,
                                v.isStatic || v.isSleeping || (v.positionPrev.x += i.x * v.inverseMass, v.positionPrev.y += i.y * v.inverseMass, v.anglePrev += r.cross(A, i) * v.inverseInertia),
            ...
            function() {
                o.collides = function(t, o, s) {
                    ...
                    if (s && d) {
                        ...
                        if (c = e(v.vertices, y.vertices, g), u.reused = !0, c.overlap <= 0) return u.collided = !1,
                        u
                    } else {
                        if (a = e(t.vertices, o.vertices, t.axes), a.overlap <= 0) return u.collided = !1,
                        u;
                        if (l = e(o.vertices, t.vertices, o.axes), l.overlap <= 0) return u.collided = !1,
                        u;
                        a.overlap < l.overlap ? (c = a, u.axisBody = t) : (c = l, u.axisBody = o),
                ...
                var e = function(e, n, o) {
                    ...
                    u = 0; u < o.length; u++) {
                        if (s = o[u], t(a, e, s), t(l, n, s), i = Math.min(a.max - l.min, l.max - a.min), i <= 0) return c.overlap = i,
                        c;
                ...
                n = function(e, t, n) {
                    for (var o, i, s, a, l = Number.MAX_VALUE,
                    c = r._temp[0], u = t.vertices, d = e.position, p = 0; p < u.length; p++) i = u[p],
                    c.x = i.x - d.x,
                    c.y = i.y - d.y,
                    o = -r.dot(n, c),
                    o < l && (l = o, s = i);
        ...
        12 : [function(e, t, n) {
            ...
            function() {
                ...
                o.solve = function(n, o) {
                    ...
                    a = n.pointA,
                    l = n.pointB;
                    i && !i.isStatic && (n.pointA = r.rotate(a, i.angle - n.angleA), n.angleA = i.angle),
                    s && !s.isStatic && (n.pointB = r.rotate(l, s.angle - n.angleB), n.angleB = s.angle);
                    var c = a,
                    u = l;
                    if (i && (c = r.add(i.position, a)), s && (u = r.add(s.position, l)), c && u) {
                        ...
                        if (! (Math.abs(1 - p / n.length) < t * o)) {
                            ...
                            i && !i.isStatic && (B = r.cross(x, M) * i.inverseInertia * (1 - n.angularStiffness), i.constraintImpulse.x -= v.x, i.constraintImpulse.y -= v.y, i.constraintImpulse.angle += B, i.position.x -= v.x, i.position.y -= v.y, i.angle += B),
                            s && !s.isStatic && (B = r.cross(h, M) * s.inverseInertia * (1 - n.angularStiffness), s.constraintImpulse.x += v.x, s.constraintImpulse.y += v.y, s.constraintImpulse.angle -= B, s.position.x += v.x, s.position.y += v.y, s.angle -= B)
                        }
                    }
                },
                    ...
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (0 !== o.x || 0 !== o.y || 0 !== o.angle) {
                            ...
                            for (var c = 0; c < n.parts.length; c++) {
                                ...
                                c > 0 && (u.position.x += o.x, u.position.y += o.y),
                                0 !== o.angle && (i.rotate(u.vertices, o.angle, n.position), l.rotate(u.axes, o.angle), c > 0 && r.rotateAbout(u.position, o.angle, n.position, u.position)),
        ...
        13 : [function(e, t, n) {
            ...
            function() {
                ...
                o.update = function(e, t) {
                    ...
                    s = e.body;
                    if (0 === n.button) {
                        if (o.bodyB) r.set(o.bodyB, !1),
                        o.pointA = n.position;
                        else for (var c = 0; c < t.length; c++) if (s = t[c], p.contains(s.bounds, n.position) && l.canCollide(s.collisionFilter, e.collisionFilter)) for (var u = s.parts.length > 1 ? 1 : 0; u < s.parts.length; u++) {
                            var d = s.parts[u];
            ...
            function() {
                ...
                o.extend = function(e, t) {
                    ...
                    for (var r = n; r < arguments.length; r++) {
                        var s = arguments[r];
                        if (s) for (var a in s) i && s[a] && s[a].constructor === Object ? e[a] && e[a].constructor !== Object ? e[a] = s[a] : (e[a] = e[a] || {},
                ...
                o.now = function() {
                    ...
                    return e.now = function() {
                        return e.now || e.webkitNow || e.msNow || e.oNow || e.mozNow ||
                        function() {
                            return + new Date
                        }
                    } (),
        ...
        15 : [function(e, t, n) {
            ...
            function() {
                ...
                o.update = function(o, i, a) {
                    ...
                    p.postSolveAll(x),
                    v.controller ? (f.isModified && v.controller.clear(v), v.controller.update(v, x, o, f.isModified), y = v.pairsList) : y = x,
        ...
        16 : [function(e, t, n) {
            ...
            function() {
                o.on = function(e, t, n) {
                    for (var o, i = t.split(" "), r = 0; r < i.length; r++) o = i[r],
                    e.events = e.events || {},
        ...
        19 : [function(e, t, n) {
            ...
            function() {
                o.create = function(t) {
                    ...
                    //     var o = e(t, n.element, n.pixelRatio),
                    //     i = t.changedTouches;
                    //     i ? (n.button = 0, t.preventDefault()) : n.button = t.button,
                    //     n.absolute.x = o.x,
                    //     n.absolute.y = o.y,
                    //     n.position.x = n.absolute.x * n.scale.x + n.offset.x,
                    //     n.position.y = n.absolute.y * n.scale.y + n.offset.y,
        ...
        20 : [function(e, t, n) {
            ...
            function() {
                ...
                o.isFor = function(e, t) {
                    var n = e.
                    for && o.dependencyParse(e.
                    for);
                    return ! e.
                    for || t.name === n.name && o.versionSatisfies(t.version, n.range)
                },
                o.use = function(e, t) {
                    ...
                    for (var n = o.dependencies(e), r = i.topologicalSort(n), s = [], a = 0; a < r.length; a += 1) if (r[a] !== e.name) {
                        var l = o.resolve(r[a]);
                        l ? o.isUsed(e, l.name) || (o.isFor(l, e) || (i.warn("Plugin.use:", o.toString(l), "is for", l.
                        for, "but installed on", o.toString(e) + "."), l._warned = !0), l.install ? l.install(e) : (i.warn("Plugin.use:", o.toString(l), "does not specify an install function."), l._warned = !0), l._warned ? (s.push("🔶 " + o.toString(l)), delete l._warned) : s.push("✅ " + o.toString(l)), e.used.push(l.name)) : s.push("❌ " + r[a])
                    }
                ...
                o.dependencies = function(e, t) {
                    ...
                    !(r in t)) {
                        ...
                        function(t) {
                            ...
                            s = o.resolve(t);
                            return s && !o.versionSatisfies(s.version, r.range) ? (i.warn("Plugin.dependencies:", o.toString(s), "does not satisfy", o.toString(r), "used by", o.toString(n) + "."), s._warned = !0, e._warned = !0) : s || (i.warn("Plugin.dependencies:", o.toString(t), "used by", o.toString(n), "could not be resolved."), e._warned = !0),
                            r.name
                        });
        ...
        21 : [function(e, t, n) {
            ...
            function() {
                ...
                o.tick = function(e, t, n) {
                    ...
                    e.isFixed ? o = e.delta: (o = n - e.timePrev || e.delta, e.timePrev = n, e.deltaHistory.push(o), e.deltaHistory = e.deltaHistory.slice( - e.deltaSampleSize), o = Math.min.apply(null, e.deltaHistory), o = o < e.deltaMin ? e.deltaMin: o, o = o > e.deltaMax ? e.deltaMax: o, a = o / e.delta, e.delta = o),
                    ...
                    t.render && t.render.controller && (i.trigger(e, "beforeRender", l), i.trigger(t, "beforeRender", l), t.render.controller.world(t.render), i.trigger(e, "afterRender", l), i.trigger(t, "afterRender", l)),
                    ...
                    i = 0; i < e.length; i++) {
                        ...
                        if (r.isActive) {
                            ...
                            if (! (a.isSleeping && l.isSleeping || a.isStatic || l.isStatic) && (a.isSleeping || l.isSleeping)) {
                                ...
                                u = c === a ? l: a; ! c.isStatic && u.motion > o._motionWakeThreshold * n && o.set(c, !1)
                            }
                        }
                    }
                },
        ...
        23 : [function(e, t, n) { (function(n) {
                ...
                function() {
                    ...
                    o.circle = function(e, t, n, i, s) {
                        ...
                        return l % 2 === 1 && (l += 1),
                        o.polygon(e, t, l, n, r.extend({},
                        a, i))
                    },
                    o.polygon = function(e, t, n, a, l) {
                        if (l = l || {},
                        n < 3) return o.circle(e, t, a, l);
                    ...
                    o.fromVertices = function(e, t, n, o, u, d, p) {
                        ...
                        for (o = o || {},
                        m = [], u = "undefined" != typeof u && u, d = "undefined" != typeof d ? d: .01, p = "undefined" != typeof p ? p: 10, c || r.warn("Bodies.fromVertices: poly-decomp.js required. Could not decompose vertices. Fallback to convex hull."), r.isArray(n[0]) || (n = [n]), b = 0; b < n.length; b += 1) if (y = n[b], v = i.isConvex(y), v || !c) y = v ? i.clockwiseSort(y) : i.hull(y),
                        m.push({
                            position: {
                                x: e,
                                y: t
                            ...
                            for (g = 0; g < m.length; g++) {
                                ...
                                for (x = g + 1; x < m.length; x++) {
                                    ...
                                    if (a.overlaps(M.bounds, k.bounds)) {
                                        var I = M.vertices,
                                        T = k.vertices;
                                        for (h = 0; h < M.vertices.length; h++) for (w = 0; w < k.vertices.length; w++) {
            ...
            function() {
                ...
                o.mesh = function(e, t, n, o, a) {
                    ...
                    for (l = 0; l < n; l++) {
                        ...
                        a)));
                        if (l > 0) for (c = 0; c < t; c++) u = f[c + (l - 1) * t],
                        d = f[c + l * t],
                        i.addConstraint(e, r.create(s.extend({
                            bodyA: u,
                            bodyB: d
                        ...
                        a))),
                        o && c > 0 && (p = f[c - 1 + (l - 1) * t], i.addConstraint(e, r.create(s.extend({
                            bodyA: p,
                            bodyB: d
                        },
                        a)))),
                        o && c < t - 1 && (p = f[c + 1 + (l - 1) * t], i.addConstraint(e, r.create(s.extend({
                            bodyA: p,
                            bodyB: d
                        },
                        a))))
                ...
                o.pyramid = function(e, t, n, i, r, s, l) {
                    return o.stack(e, t, n, i, r, s,
                    function(t, o, s, c, u, d) {
        ...
        27 : [function(e, t, n) {
            ...
            function() {
                ...
                var e = function(e) {
                    for (var t, n, o, i, r, s, a = e.pathSegList,
                    l = 0,
                    c = 0,
                    u = a.numberOfItems,
                    d = 0; d < u; ++d) {
        ...
        29 : [function(e, t, n) {
            ...
            function() {
                ...
                o.area = function(e, t) {
                    for (var n = 0,
                    o = e.length - 1,
                    i = 0; i < e.length; i++) n += (e[o].x - e[i].x) * (e[o].y + e[i].y),
                    o = i;
                ...
                o.inertia = function(e, t) {
                    ...
                    s = 0,
                    a = e,
                    l = 0; l < a.length; l++) o = (l + 1) % a.length,
                ...
                o.translate = function(e, t, n) {
                    var o;
                    if (n) for (o = 0; o < e.length; o++) e[o].x += t.x * n,
                    e[o].y += t.y * n;
                    else for (o = 0; o < e.length; o++) e[o].x += t.x,
                    e[o].y += t.y;
                    return e
                },
                ...
                o.scale = function(e, t, n, r) {
                    if (1 === t && 1 === n) return e;
                    r = r || o.centre(e);
                    for (var s, a, l = 0; l < e.length; l++) s = e[l],
                    a = i.sub(s, r),
                    e[l].x = r.x + a.x * t,
                    e[l].y = r.y + a.y * n;
                    return e
        ...
        31 : [function(e, t, n) {
            ...
            function() {
                ...
                o.lookAt = function(e, t, n, o) {
                    ...
                    o && (e.bounds.min.x += .5 * d - d * g * .5, e.bounds.max.x += .5 * d - d * g * .5, e.bounds.min.y += .5 * p - p * x * .5, e.bounds.max.y += .5 * p - p * x * .5),
                    e.bounds.min.x -= n.x,
                    e.bounds.max.x -= n.x,
                    e.bounds.min.y -= n.y,
                    e.bounds.max.y -= n.y,
                ...
                o.world = function(e) {
                    ...
                    x = v; ! m.wireframes || n.enableSleeping && m.showSleeping ? o.bodies(e, x, p) : (m.showConvexHulls && o.bodyConvexHulls(e, x, p), o.bodyWireframes(e, x, p)),
                ...
                o.constraints = function(e, t) {
                    ...
                    o = 0; o < e.length; o++) {
                        ...
                        if (i.render.visible && i.pointA && i.pointB) {
                            var r = i.bodyA,
                            s = i.bodyB;
                            r ? (n.beginPath(), n.moveTo(r.position.x + i.pointA.x, r.position.y + i.pointA.y)) : (n.beginPath(), n.moveTo(i.pointA.x, i.pointA.y)),
                            s ? n.lineTo(s.position.x + i.pointB.x, s.position.y + i.pointB.y) : n.lineTo(i.pointB.x, i.pointB.y),
                            i.render.lineWidth && (n.lineWidth = i.render.lineWidth, n.strokeStyle = i.render.strokeStyle, n.stroke())
                        }
                    }
                },
                o.bodyShadows = function(e, t, n) {
                    for (var o = n,
                    i = (e.engine, 0); i < t.length; i++) {
                        var r = t[i];
                        if (r.render.visible) {
                            if (r.circleRadius) o.beginPath(),
                ...
                o.bodies = function(e, t, n) {
                    ...
                    for (r = 0; r < t.length; r++) if (o = t[r], o.render.visible) for (s = o.parts.length > 1 ? 1 : 0; s < o.parts.length; s++) if (i = o.parts[s], i.render.visible) {
                ...
                o.bodyWireframes = function(e, t, n) {
                    ...
                    for (l.beginPath(), r = 0; r < t.length; r++) if (o = t[r], o.render.visible) for (a = o.parts.length > 1 ? 1 : 0; a < o.parts.length; a++) {
                        for (i = o.parts[a], l.moveTo(i.vertices[0].x, i.vertices[0].y), s = 1; s < i.vertices.length; s++) ! i.vertices[s - 1].isInternal || c ? l.lineTo(i.vertices[s].x, i.vertices[s].y) : l.moveTo(i.vertices[s].x, i.vertices[s].y),
                ...
                o.vertexNumbers = function(e, t, n) {
                    ...
                    for (o = 0; o < t.length; o++) {
                        ...
                        for (r = a.length > 1 ? 1 : 0; r < a.length; r++) {
                            var l = a[r];
                            for (i = 0; i < l.vertices.length; i++) s.fillStyle = "rgba(255,255,255,0.2)",
                ...
                o.bodyBounds = function(e, t, n) {
                    ...
                    for (var r = 0; r < t.length; r++) {
                        var s = t[r];
                        if (s.render.visible) for (var a = t[r].parts, l = a.length > 1 ? 1 : 0; l < a.length; l++) {
                            var c = a[l];
                ...
                o.bodyAxes = function(e, t, n) {
                    ...
                    for (a.beginPath(), i = 0; i < t.length; i++) {
                        var c = t[i],
                        u = c.parts;
                        if (c.render.visible) if (l.showAxes) for (r = u.length > 1 ? 1 : 0; r < u.length; r++) for (o = u[r], s = 0; s < o.axes.length; s++) {
                            var d = o.axes[s];
                            a.moveTo(o.position.x, o.position.y),
                            a.lineTo(o.position.x + 20 * d.x, o.position.y + 20 * d.y)
                        } else for (r = u.length > 1 ? 1 : 0; r < u.length; r++) for (o = u[r], s = 0; s < o.axes.length; s++) a.moveTo(o.position.x, o.position.y),
                ...
                o.bodyPositions = function(e, t, n) {
                    var o, i, r, s, a = n,
                    l = (e.engine, e.options);
                    for (a.beginPath(), r = 0; r < t.length; r++) if (o = t[r], o.render.visible) for (s = 0; s < o.parts.length; s++) i = o.parts[s],
                    a.arc(i.position.x, i.position.y, 3, 0, 2 * Math.PI, !1),
                    a.closePath();
                    for (l.wireframes ? a.fillStyle = "indianred": a.fillStyle = "rgba(0,0,0,0.5)", a.fill(), a.beginPath(), r = 0; r < t.length; r++) o = t[r],
                    o.render.visible && (a.arc(o.positionPrev.x, o.positionPrev.y, 2, 0, 2 * Math.PI, !1), a.closePath());
                ...
                o.collisions = function(e, t, n) {
                    ...
                    for (l.wireframes ? a.fillStyle = "rgba(255,255,255,0.7)": a.fillStyle = "orange", a.fill(), a.beginPath(), r = 0; r < t.length; r++) if (o = t[r], o.isActive && (i = o.collision, o.activeContacts.length > 0)) {
                        ...
                        2 === o.activeContacts.length && (d = (o.activeContacts[0].vertex.x + o.activeContacts[1].vertex.x) / 2, p = (o.activeContacts[0].vertex.y + o.activeContacts[1].vertex.y) / 2),
        ...
        32 : [function(e, t, n) {
            ...
            function() {
                ...
                o.constraint = function(e, t) {
                    ...
                    l.visible && t.pointA && t.pointB ? (s.indexOf(a.children, u) === -1 && a.addChild(u), u.clear(), u.beginFill(0, 0), u.lineStyle(l.lineWidth, s.colorToNumber(l.strokeStyle), 1), n ? u.moveTo(n.position.x + i.x, n.position.y + i.y) : u.moveTo(i.x, i.y), o ? u.lineTo(o.position.x + r.x, o.position.y + r.y) : u.lineTo(r.x, r.y), void u.endFill()) : void u.clear()
                },
                o.body = function(e, t) {
                    ...
                    if (o.visible) if (o.sprite && o.sprite.texture) {
                        ...
                        u = e.primitives[l],
                        d = e.container;
                        u || (u = e.primitives[l] = c(e, t), u.initialAngle = t.angle),
                ...
                c = function(e, t) {
                    ...
                    for (var p = t.parts.length > 1 ? 1 : 0; p < t.parts.length; p++) {
                        n = t.parts[p],
                        i.wireframes ? (r.beginFill(0, 0), r.lineStyle(1, u, 1)) : (r.beginFill(a, 1), r.lineStyle(o.lineWidth, l, 1)),
                        ...
                        r.endFill(),
                        (i.showAngleIndicator || i.showAxes) && (r.beginFill(0, 0), i.wireframes ? r.lineStyle(1, d, 1) : r.lineStyle(1, c), r.moveTo(n.position.x - t.position.x, n.position.y - t.position.y), r.lineTo((n.vertices[0].x + n.vertices[n.vertices.length - 1].x) / 2 - t.position.x, (n.vertices[0].y + n.vertices[n.vertices.length - 1].y) / 2 - t.position.y), r.endFill())
                    }
                    return r
                },
                u = function(e, t) {
